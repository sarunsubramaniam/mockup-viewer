...
var imgList = [{
		...
		for (var images = 0; images < imgList.length; images++) {
            svgList.push($('<li><svg x="0px" y="0px" width="1080px" height="1920px" viewBox="0 0 1080 1920" style="enable-background:new 0 0 1080 1920;" xml:space="preserve"><use xlink:href="'+imgList[images].Image+'#Layer_1"></use></svg></li>').appendTo('.bxslider'));
		}
